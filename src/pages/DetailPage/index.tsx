...
const DetailPage = () => {
    ...
    async function fetchPokemonData(id: string) {
        ...
        try {
            ...
            if (pokemonData) {
                ...
                const nextAndPreviousPokemon: NextAndPreviousPokemon = await getNextPreviousPokemon(id);
    ...
    const filterAndFormatDescription = (flavorText: FlavorTextEntry[]): string[] => {
        const koreanDescriptions = flavorText?.filter((text: FlavorTextEntry) => text.language.name === "ko")
    ...
    async function getNextPreviousPokemon(id: number) {
        ...
        return (
            <article className='flex items-center gap-1 flex-col w-full'>
                <div className={
                    ...
                    <section className='w-full flex flex-col z-20 items-center justify-end relative h-full'>
                        <div className='absolute z-30 top-6 flex items-center w-full justify-between px-2'>
                            <div className='flex items-center gap-1'>
                                <Link to="/">
                                    <ArrowLeft className='w-6 h-9 text-zinc-200'/>
                                </Link>
                    ...
                    <section
                        className='
                    w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4'
                    >
                        ...
                        <div className='flex my-0 flex-wrap justify-center'>
